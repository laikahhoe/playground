...
public class HyperSqlDbServer implements SmartLifecycle
{
 ...
 public HyperSqlDbServer()
 {
	 ...
	 p.put("server.database.0", "file:c:/kahhoe/app/hsqldb/demobase");
	 p.put("server.dbname.0", "demobase");
	 p.put("server.remote_open", "true");
	 p.put("hsqldb.reconfig_logging", "false");
	 properties = new HsqlProperties(p);
//	 server.database.0=file:c:/kahhoe/app/hsqldb/demobase
